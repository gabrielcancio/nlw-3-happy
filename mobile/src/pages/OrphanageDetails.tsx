...
export default function OrphanageDetails() {
  ...
  const params = route.params as RouteParams; // Não usar useEffect para buscar os route params
  ...
  if(!orphanage) { // Verificação que exime o estado orphanage de ser undefined
    return( // Obs: Fazer um shimmer effect
    ...
    <ScrollView style={styles.container}>
      ...
      <View style={styles.detailsContainer}>
        ...
        <View style={styles.mapContainer}>
          ...
          <RectButton onPress={() => handleOpenGoogleMapsRoutes(orphanage.latitude, orphanage.longitude)} style={styles.routesContainer}>
